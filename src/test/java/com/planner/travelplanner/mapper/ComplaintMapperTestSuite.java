...
public class ComplaintMapperTestSuite {
    ...
    private void dataForTests(){
        customer = new Customer(1L, "firstName", "lastName", new Date(2020,02,02), "string","string", "string", "string", "string", 1231231, new ArrayList<>(), null);
        LocalDateTime complaintDate = LocalDateTime.of(2023, 5, 15, 12, 0);
        complaint1 = new Complaint(1,"title1","description1",complaintDate,"test1", 1L);
        complaint2 = new Complaint(1,"title2","description2",complaintDate,"test2", 1L);
